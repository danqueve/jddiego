...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            /* Forzar colores de texto en impresión */
        ...
        <div class="row mb-4">
                ...
                <div class="p-3 bg-light border rounded">
                    ...
                    <table class="table table-borderless table-sm mb-0">
                        <tr>
                            ...
                            <td class="fw-bold"><?php echo htmlspecialchars($cliente['nombre'] . ' ' . $cliente['apellido']); ?></td>
                        </tr>
                        <tr>
            ...
            <div class="col-md-5">
                <div class="p-3 border rounded bg-white text-center h-100 d-flex flex-column justify-content-center">
                    ...
                    <h2 class="display-5 fw-bold text-danger mb-0">$<?php echo number_format($saldo_total, 2); ?></h2>
                </div>
            </div>
        </div>
                        ...
                        <td class="text-end">
                            <?php if ($es_venta): ?>
                                <?php if ($mov['saldo_pendiente'] > 0.01): ?>
                                    <span class="text-danger fw-bold">Pend: $<?php echo number_format($mov['saldo_pendiente'], 2); ?></span>
                                <?php else: ?>
