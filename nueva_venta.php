                    ...
                    <form id="formProcesarVenta">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" id="inputDescuento" name="descuento" value="0" min="0" max="100" step="1">
        ...
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body">
                <div class="input-group input-group-lg mb-3">
                    ...
                    <input type="text" id="inputBusquedaModal" class="form-control" placeholder="Filtrar por código o descripción...">
                </div>
                    ...
                    <?php foreach ($articulos_para_modal as $item): ?>
                        <a href="#" class="list-group-item list-group-item-action item-busqueda" 
                           ...
                           data-texto-busqueda="<?php echo strtolower(htmlspecialchars($item['descripcion'] . ' ' . $item['codigo'])); ?>">
                            ...
                            <span class="text-success fw-bold">$<?php echo number_format($item['precio_venta'], 2); ?></span> 
            ...
            success: function(response) {
                if (response.status === 'success') {
                    Swal.fire({
                        ...
                        var ventaIdMatch = response.message.match(/ID: (\d+)/);
                        if (ventaIdMatch && ventaIdMatch[1]) {
                             window.open('remito.php?id=' + ventaIdMatch[1], '_blank');
                        }
