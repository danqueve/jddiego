...
<div class="container mt-5 pt-5">
    ...
    <div class="card shadow-sm border-0 mb-3 bg-light">
        <div class="card-body py-3">
            <form method="GET" action="ventas.php" class="row g-2 align-items-center">
                <div class="col-auto">
                ...
                <div class="col-auto">
                    ...
                    <a href="ventas.php" class="btn btn-outline-secondary btn-sm ms-1">Hoy</a>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="tablaVentas" class="table table-striped table-hover" style="width:100%">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT v.id, v.fecha, v.tipo_pago, v.total, v.saldo_pendiente, u.nombre_usuario AS vendedor, IFNULL(CONCAT(c.nombre, ' ', c.apellido), 'Consumidor Final') AS cliente, v.id_cliente
                                FROM ventas v 
                        ...
                        while ($row = $stmt->fetch()) {
                            ...
                            echo "<td>
                                    <div class='btn-group' role='group'>
                                        ...
                                        " . (($row['id_cliente'] > 1) ? "<a href='ficha_cliente.php?id=" . $row['id_cliente'] . "' class='btn btn-secondary btn-sm' title='Ficha Cliente'><i class='bi bi-person-lines-fill'></i></a>" : '') . "
                    ...
                    <div class="row">
                        <div class="col-md-8 border-end">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="busquedaEditar" class="form-control"
                                    placeholder="Buscar para agregar artículo...">
                            </div>
                            <div id="resultadosEditar" class="list-group mb-3 shadow"
                                style="position: absolute; z-index: 1055; width: 60%; max-height: 200px; overflow-y: auto; display: none;">
                            </div>
                        ...
                        <div class="col-md-4">
                                ...
                                <select id="edit_id_cliente" class="form-select" required>
                                    ...
                                    <?php foreach ($clientes as $c): ?>
                                        <option value="<?php echo $c['id']; ?>">
                                            <?php echo htmlspecialchars($c['nombre_completo']); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" id="edit_descuento" class="form-control" min="0" max="100"
                                        value="0">
                            ...
                            <div class="d-flex justify-content-between mb-2"><span>Subtotal:</span><span
                                    id="lblSubtotal">$0.00</span></div>
                            <div class="d-flex justify-content-between mb-2 text-danger"><span>Desc.:</span><span
                                    id="lblDescuento">-$0.00</span></div>
                            <div class="d-flex justify-content-between fs-4 fw-bold border-top pt-2">
                                <span>Total:</span><span id="lblTotal" class="text-primary">$0.00</span></div>
                        </div>
                    </div>
                </form>
            </div>
